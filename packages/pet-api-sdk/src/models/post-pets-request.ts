 ...
 */
export function instanceOfPostPetsRequest(
  value: object,
): value is PostPetsRequest {
...
export function PostPetsRequestFromJSONTyped(
  json: any,
...
export function PostPetsRequestToJSONTyped(
  value?: PostPetsRequest | null,
