 ...
 */
export function instanceOfPostUsersRequest(value: object): value is PostUsersRequest {
...
export function PostUsersRequestToJSONTyped(value?: PostUsersRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
